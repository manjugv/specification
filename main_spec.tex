...
\subsection{Sets and Groups}\label{subsec:sgroups}
\subsubsection{\textbf{SETS}}
\input{content/sets_intro.tex}

\subsubsection{\textbf{SHMEM\_CREATE\_SET\_STRIDED}}
\input{content/shmem_create_set_strided.tex}

\subsubsection{\textbf{SHMEM\_CREATE\_SET\_STRIDED\_MULTI}}
\input{content/shmem_create_set_strided_multi.tex}

\subsubsection{\textbf{SHMEM\_CREATE\_SET\_RANGE}}
\input{content/shmem_create_set_range.tex}

\subsubsection{\textbf{SHMEM\_CREATE\_SET\_RANGE\_MULTI}}
\input{content/shmem_create_set_range_multi.tex}

\subsubsection{\textbf{SHMEM\_FREE\_SET}}
\input{content/shmem_free_set.tex}

\subsubsection{\textbf{SHMEM\_SET\_QUERY\_SIZE}}
\input{content/shmem_set_query_size.tex}

\subsubsection{\textbf{SHMEM\_SET\_GET\_INDEX}}
\input{content/shmem_set_get_index.tex}

\subsubsection{\textbf{SHMEM\_SET\_TRANSLATE\_INDEX}}
\input{content/shmem_set_translate_index.tex}

\subsubsection{\textbf{GROUPS}}
\input{content/groups_intro.tex}

\subsubsection{\textbf{SHMEM\_CREATE\_GROUP\_FROM\_SET}}
\input{content/shmem_create_group_from_set.tex}

\subsubsection{\textbf{SHMEM\_GROUP\_FREE}}
\input{content/shmem_group_free.tex}

\subsubsection{\textbf{SHMEM\_GROUP\_QUERY\_SIZE}}
\input{content/shmem_group_query_size.tex}

\subsubsection{\textbf{SHMEM\_GET\_SET\_FROM\_GROUP}}
\input{content/shmem_get_set_from_group.tex}
