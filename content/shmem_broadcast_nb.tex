...
\apidescription{   
    ...
    Similar to blocking broadcast, before any \ac{PE} calls a broadcast routine, the following
...
\apinotes{
    ...
    all \acp{PE} in the team are ready to accept the broadcast data before
    updates may occur.
...
\apicexample
    ...
    params on \acp{PE} $0\dots npes-1$ to the \dest{} params on \acp{PE} $0\dots npes-1$. This effectively performs a \FUNC{shmem\_fcollect} operation using nonblocking broadcasts.}
