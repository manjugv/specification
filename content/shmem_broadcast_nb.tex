...
\apicexample
    ...
    params on \ac{PE} $0\dots npes-1$ to the \dest{} params on \acp{PE} $0\dots npes-1$. This effectively performs a \FUNC{shmem\_collect} operation using nonblocking broadcasts.}
