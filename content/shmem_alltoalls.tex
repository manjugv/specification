...
\apidescription{
    ...
    conditions must exist: The \VAR{pSync} array on all \acp{PE} in the
    ...
    \FUNC{shmem\_alltoalls} data. Synchronization via a barrier or similar method is
    typical to ensure these conditions.
