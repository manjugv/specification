...
collective operation and the collective operations must be initiated in the same
program order across all \acp{PE} while the executions may be performed in any order.
